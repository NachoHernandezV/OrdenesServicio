/*
*	mysqlwslib.js
*		Forma parte del paquete de acceso a mysql junto con el fichero mysqlws.php
*		Para utilizar el paquete se deben instalar los dos ficheros en el servidor donde 
*		tengamos instalado mysql.
*		En el fichero, mysqlws.php, hay que configurar las variables:
*				$host, $user, $pw, $db
...
*		este fichero y la base de datos por defecto.
*
